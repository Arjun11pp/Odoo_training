...
class WebsiteCustomerForm(http.Controller):
    ...
    # Subscription page
    @http.route('/website/subscriptions/view', type='http', auth='user', website=True)
    ...
    @http.route('/website/subscription/form', type='http', auth='user', website=True)
    ...
    @http.route('/website/unique_subscriptions/views', type='http', auth='user', website=True)
    ...
    @http.route('/website/confirm_subscription/views', type='http', auth='user', website=True)
    ...
    @http.route('/website/subscription/create', type='http', auth='user', methods=['POST'], website=True, csrf=True)
    ...
    @http.route('/website/credit/form', type='http', auth='user', website=True)
    def credit_form(self, **kw):
        subscriptions = request.env['recurring.subscription'].search([])
        return request.render('recurring_subscription.credit_form_template',{'subscriptions': subscriptions})

    @http.route('/website/credit/create', type='http', auth='user', methods=['POST'], website=True, csrf=True)
    ...
    @http.route('/check_condition', type='http', auth='user',website=True)
    def my_handler(self, **post):
        return http.request.render('recurring_subscription.credit_list', {
            'warning_msg': "Something went wrong!"
        })

    @http.route('/website/credit/view', type='http', auth='user', website=True)
    ...
    @http.route('/website/approve_credit/views', type='http', auth='user', website=True)
    ...
    @http.route('/website/unique_credit/views', type='http', auth='user', website=True)
    ...
    @http.route('/website/billing/form', type='http', auth='user', website=True)
    ...
    @http.route('/website/billing/view', type='http', auth='user', website=True )
    ...
    @http.route('/website/billings/create', type='http', auth='user', methods=['POST'], website=True)
    ...
    @http.route('/website/unique_billing/views', type='http', auth='user', website=True)
    ...
    @http.route('/website/billing_create_invoice/views', type='http', auth='user', website=True)
    ...
    @http.route('/get_credit_list', auth="user", type='jsonrpc', website=True)
    def get_product_category(self):
        partner = request.env.user.partner_id
        credits_ids = request.env['recurring.subscription.credit'].search_read([('partner_id','=',partner.id),('state','=','approved')],fields=['id','recurring_subscription_id',
                'partner_id','credit_amount', 'state', 'credit_image'], order='credit_amount DESC' )
        return {
            'credits_ids': credits_ids,
        }

    @http.route('/get_credit_detail/<int:credit_id>', auth="user",   type='http', website=True)
